...
const ProjectsPage: React.FC = () => {
  ...
  const handleManageClick = async (Id) => {
    ...
    let allStudents = await response.data.filter(
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <Link href={`/projects/${project._id}`}>
              ...
              <LanguageIcon languageId={project.languageId} />
              <p className="mt-3 testfont">{project.description}</p>
            </Link>
            ...
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 text-red-600 ml-auto cursor-pointer transform hover:rotate-12 transition-transform duration-300 ease-in-out"
